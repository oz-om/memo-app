...
export const Input = (props) => {
  ...
  return (
    <div className='mt-5'>
      ...
      <input type={type} placeholder={placeholder} name={name} onInput={method} className='border-2 border-orange-500/25 rounded-xl outline-none pl-3 py-2 block w-full' />
    </div>
  );
};
...
export const FormBtn = (props) => {
  ...
  return <button className={"text-white font-bold py-2 px-4 bg-orange-500 border-orange-800 border-1 rounded-xl my-5 " + addStyle}>{name}</button>;
};
